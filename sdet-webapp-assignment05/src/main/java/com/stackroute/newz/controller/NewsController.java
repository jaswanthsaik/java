...
public class NewsController {
	 ...
	 */
		...
		public News getEmployee(@PathVariable int newsId) throws NewsNotExistsException {
	 ...
	 */
		...
		public News addNews(@RequestBody News news) throws NewsAlreadyExistsException {
	 ...
	 */
		@PutMapping("/news")
		public News updateNews(@RequestBody News news) throws NewsNotExistsException {
	 ...
	 */
		...
		public void deleteNews(@PathVariable("newsId") int newsId) throws NewsNotExistsException {
